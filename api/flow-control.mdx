...
- [OpenHome-local Template](/templates/basic) - Full example of LLM → terminal integration
- [openclaw Template](/templates/api) - Desktop agent control
...
- [SendEmail Template](/templates/basic) - Complete email sending example
